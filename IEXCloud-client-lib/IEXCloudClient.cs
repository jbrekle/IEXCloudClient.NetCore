...
namespace IEXCloudClient.NetCore
{
    public class IEXCloudClient : IIEXCloudClient
	{
		...
		private static readonly Throttler _throttler = new Throttler();
        ...
        private void Sign(HttpRequestMessage request){
			...
			var data = _signer.GenerateSigningData(request.Method.Method, canonical_uri, canonical_querystring, access_key, secret_key, this._host);
